...
TARGET_FAMILIES: dict[str, dict] = {
    ...
    # ── CHROME HEARTS (piece-specific families, March 2026 optimization) ──
    "ch_pendants": {
        "canonical": "chrome hearts baby fat cross pendant",
        "aliases": [
            "chrome hearts baby fat cross pendant", "chrome hearts baby fat pendant",
            "chrome hearts tiny e", "chrome hearts tiny e cross pendant",
            "chrome hearts floral cross pendant", "chrome hearts floral cross",
            "chrome hearts dagger pendant",
            "chrome hearts cemetery cross pendant", "chrome hearts cemetery cross",
            "chrome hearts nail cross pendant",
            "chrome hearts filigree cross pendant",
            "chrome hearts cross pendant", "chrome hearts ch cross pendant",
        ],
        "broad_allowed": False,
        "allowed_queries": [
    ...
    "ch_rings": {
        ...
        "aliases": [
            "chrome hearts forever ring", "chrome hearts spacer ring",
            "chrome hearts scroll band ring", "chrome hearts scroll ring",
            "chrome hearts fuck you ring", "chrome hearts spinner ring",
            "chrome hearts plus ring", "chrome hearts ch plus ring",
            "chrome hearts keeper ring",
            "chrome hearts cemetery ring", "chrome hearts cemetery cross ring",
            "chrome hearts dagger ring",
            "chrome hearts floral cross ring",
            "chrome hearts sbt band ring",
            "chrome hearts cross ring", "chrome hearts horseshoe ring",
            "chrome hearts bubblegum ring", "chrome hearts baby fat ring",
    ...
    "ch_bracelets": {
        ...
        "aliases": [
            "chrome hearts paper chain bracelet", "chrome hearts paper chain",
            "chrome hearts roller cross bracelet", "chrome hearts rollercoaster bracelet",
            "chrome hearts plus bracelet", "chrome hearts ch plus bracelet",
            "chrome hearts fancy link bracelet",
            "chrome hearts morning star bracelet",
            "chrome hearts bead bracelet",
            "chrome hearts cross bracelet", "chrome hearts scroll bracelet",
            "chrome hearts dagger bracelet", "chrome hearts id bracelet",
        ],
        "broad_allowed": False,
        "allowed_queries": [
    ...
    "ch_chains": {
        ...
        "aliases": [
            ...
            "chrome hearts necklace", "chrome hearts chain",
        ],
        "broad_allowed": False,
        "allowed_queries": [
            "chrome hearts paper chain necklace",
    ...
    "ch_tees": {
        ...
        "aliases": [
            "chrome hearts horseshoe tee", "chrome hearts tee",
            "chrome hearts scroll tee",
            "chrome hearts fuck you tee",
            "chrome hearts matty boy sex records", "chrome hearts matty boy tee",
            "chrome hearts matty boy chomper", "chrome hearts matty boy",
            ...
            "chrome hearts neck logo long", "chrome hearts baby rib tank",
            "chrome hearts las vegas exclusive",
        ],
        "broad_allowed": False,
        "allowed_queries": [
    ...
    "ch_hoodies": {
        ...
        "aliases": [
            "chrome hearts cross patch hoodie", "chrome hearts zip up hoodie",
            "chrome hearts cemetery hoodie",
            "chrome hearts matty boy sex records hoodie", "chrome hearts matty boy hoodie",
    ...
    "ch_apparel_other": {
        ...
        "aliases": [
            "chrome hearts neck logo long sleeve", "chrome hearts long sleeve",
        ...
        "broad_allowed": False,
        "allowed_queries": [
            "chrome hearts neck logo long sleeve",
            "chrome hearts thermal",
            "chrome hearts crewneck",
            "chrome hearts sweatpants",
            "chrome hearts shorts",
    ...
    "ch_denim": {
        ...
        "aliases": [
            "chrome hearts cross patch jeans", "chrome hearts jeans",
            "chrome hearts cross patch flannel", "chrome hearts flannel",
            "chrome hearts fleur knee jeans",
            "chrome hearts denim jacket", "chrome hearts trucker jacket",
        ],
        "broad_allowed": False,
        "allowed_queries": [
    ...
    "ch_eyewear": {
        ...
        "aliases": [
            "chrome hearts trypoleagain glasses", "chrome hearts trypoleagain",
            "chrome hearts vagilante glasses", "chrome hearts vagilante",
            "chrome hearts see you tea",
            "chrome hearts gittin any glasses", "chrome hearts gittin any frame",
            "chrome hearts paper jam glasses", "chrome hearts paper jam triple",
            "chrome hearts penetranus sunglasses",
            "chrome hearts bone prone glasses",
            "chrome hearts sunglasses", "chrome hearts glasses",
        ],
        "broad_allowed": False,
        "allowed_queries": [
    ...
    "ch_accessories": {
        ...
        "aliases": [
            "chrome hearts pony hair trucker", "chrome hearts pony hair triple",
            "chrome hearts cross patch hat",
            "chrome hearts beanie",
            "chrome hearts belt",
            "chrome hearts converse",
            "chrome hearts rolling stones",
            "chrome hearts hat", "chrome hearts trucker hat",
            "chrome hearts boots",
        ],
        "broad_allowed": False,
        "allowed_queries": [
